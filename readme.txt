...
* Easy plugin translation platform with GlotPress tool: [Translate "Cleaner Plugin Installer"...](https://translate.wordpress.org/projects/wp-plugins/cleaner-plugin-installer)
...
== Plugin Links ==
* [WordPress.org Translations Platform](https://translate.wordpress.org/projects/wp-plugins/cleaner-plugin-installer)
...
== Donate ==
Enjoy using *Cleaner Plugin Installer*? Please consider [making a small donation](https://www.paypal.me/deckerweb) to support the project's continued development.
